...
@section('body')
    ...
    @endsession
    <form method="POST" id="regForm" action="{{ url('store') }}">
        @csrf
        <!-- One "tab" for each step in the form: -->
        <div class="tab">
            <strong class="m-3">Admission Timings</strong>
            <div class="d-flex flex-lg-wrap">
                <x-forms.date-time-input name="admission_start_time"/>
                <x-forms.date-time-input name="OR_start_time"/>
                <x-forms.date-time-input name="surgery_start_time"/>
                <x-forms.date-time-input name="anesthesia_start_time"/>
                <x-forms.date-time-input name="surgery_end_time"/>
                <x-forms.date-time-input name="anesthesia_end_time"/>
                <x-forms.date-time-input name="OR_discharge_end_time"/>
                <x-forms.date-time-input name="RR_time_out"/>
            </div>
            ...
            <div>
                ...
                <div class="input-group">
                    ...
                    <input class="col-9 form-control" type="text" id="approval_notes" name="approval_notes" placeholder="Enter note if you have any" value="{{old('approval_notes')}}">
                </div>
        ...
        <div class="tab col-md-12">
            ...
            <div>
                ...
                <input id="signatureJSON" name="signature" class="d-none" value="{{old('signature')}}"></input>
            </div>
        </div>
